...
/**
 * ViewGroup that draws a mGridView of calendar cells.  All children must be {@link CalendarRowView}s.
 * The first row is assumed to be a header and no divider is drawn above it.
 */
public class CalendarGridView extends ViewGroup {
    /**
     * The mGridView lines don't exactly line up on certain devices (Nexus 7, Nexus 5). Fudging the
